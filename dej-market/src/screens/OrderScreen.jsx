            ...
            <ListGroup variant='flush'>
              ...
              {/* {!order.isPaid && (
                <ListGroup.Item>
                    {loadingPay && <Loader />}
                    {!sdkReady ? <Loader /> :(
                      <Button className='' amount={order.totalPrice} onSuccess=
                      {successPaymentHandler}>PAY HERE</Button>
                    )}
...
{/* {!order.isPaid && (
    <ListGroup.Item>
        {!sdkReady ? null : (
            <Button className='btn' amount={order.totalPrice} onSuccess={successPaymentHandler}>PAY HERE</Button>
        )}
    </ListGroup.Item>
)} */}
